...
export class ResidencesComponent implements OnInit{
  listResidences:Residence[]=[];
    ...
    constructor(private router: Router,private Service: Service,private residenceService: ResidenceService) {
  ...
  getSimilarAddresses(address: string): number {
    return this.Service.getSameValueOf(this.listResidences, 'address', address);
  }
